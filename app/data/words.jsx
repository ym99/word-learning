export const words = [
    ...
    /* 048 */ { new: true, spanish: 'entender', english: 'to understand' },
    ...
    { new: true, spanish: 'tuerte', english: 'strong + when speaking' },
    ...
    { new: true, spanish: 'jugar', english: 'to play + sport' },
    { new: true, spanish: 'tocar', english: 'to play + musical intrument' },
    { new: true, spanish: 'escalera', english: 'stairs' },
    { new: true, spanish: 'conocimiento', english: 'knowledge' },
    { new: true, spanish: 'junto', english: 'together' },
    { new: true, spanish: 'padre', english: 'father' },
    { new: true, spanish: 'mother', english: 'madre' },
    { new: true, spanish: 'dad', english: 'papá' },
    { new: true, spanish: 'mom', english: 'mamá' },
    { new: true, spanish: 'hermano', english: 'brother' },
    { new: true, spanish: 'hermana', english: 'sister' },
    { new: true, spanish: 'hijo', english: 'son' },
    { new: true, spanish: 'hija', english: 'daugther' },
    { new: true, spanish: ['primo', 'prima'], english: 'cousin' },
    { new: true, spanish: 'abuelo', english: 'grandfather' },
    { new: true, spanish: 'abuela', english: 'grandmother' },
];
/*
    á Alt + 0225
    é Alt + 0233
