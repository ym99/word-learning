export const words = [
    ...
    { hide: true, new: true, spanish: 'ayer', english: 'yesterday' },
    { hide: true, new: true, spanish: 'vamos', english: 'come on' },
    { hide: true, new: true, spanish: 'trompeta', english: 'trumpet' },
    { hide: true, new: true, spanish: 'hoy', english: 'today' },
    { hide: true, new: true, spanish: 'en punto', english: 'o\'clock' },
    { hide: true, new: true, spanish: 'anoche', english: 'last night' },
    { hide: true, new: true, spanish: 'en la mañana', english: 'morning' },
    { hide: true, new: true, spanish: 'mañana', english: 'tomorrow' },
    { hide: true, new: true, spanish: 'otro día', english: 'other day' },
    { hide: true, new: true, spanish: 'pasado', english: 'past + last' },
];
/*
