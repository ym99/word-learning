export const words = [
    ...
    /* 007 */ { new: true, spanish: 'de', english: 'of' },
    /* 008 */ { new: true, spanish: 'su', english: ['your', 'her', 'his', 'their'] },
    ...
    /* 013 */ { new: true, spanish: 'en', english: ['on', 'in'] },
    ...
    /* 032 */ { new: true, spanish: 'hola', english: 'hello' },
    ...
    /* 039 */ { new: true, spanish: 'como', english: ['like', 'as'] },

    /* 040 */ { new: true, spanish: 'donde', english: 'where' },
    /* 041 */ { spanish: 'dar', english: 'to give' },
    /* 042 */ { new: true, spanish: 'pero', english: 'but' },
    /* 043 */ { new: true, spanish: 'se', english: ['itself', 'herself', 'himself', 'themselves'] },
    /* 044 */ { new: true, spanish: 'mucho', english: 'much' },
    /* 045 */ { new: true, spanish: 'nuevo', english: 'new' },
    /* 046 */ { spanish: 'cuando', english: 'when' },
    /* 047a*/ { new: true, spanish: 'chico', english: 'boy' },
    /* 047b*/ { new: true, spanish: 'chica', english: 'girl' },
    /* 048 */ { spanish: 'entender', english: 'to understand' },
    /* 049 */ { new: true, spanish: 'si', english: ['if', 'yes'] },

    /* 050 */ { new: true, spanish: 'o', english: 'or' },
    ...
    { spanish: 'dad', english: 'papá' },
    { spanish: 'mom', english: 'mamá' },
